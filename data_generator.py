...
class DataGenerator(object):
    def __init__(self, config={}):
        ...
        #demo_file = demo_file[int(3*len(demo_file)/4):]
    ...
    def generate_batches(self, noisy=False):
        with Timer('Generating batches for each iteration'):
            ...
            #train_img_folders = train_img_folders[int(3*len(train_img_folders)/4):]
            #val_img_folders = val_img_folders[int(3*len(val_img_folders)/4):]
